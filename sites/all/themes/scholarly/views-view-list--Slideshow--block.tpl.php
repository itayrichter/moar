    ...
    <div class="flexslider">
        ...
        if ($node->type=='mt_slideshow_entry') {
            ...
            <div class="caption-wrapper">  
                ...
                <?php 
                    $text_teaser = $node->field_teaser_text[$lang][0]['value'];  $text_teaser_suffix=""; if (strlen($text_teaser)>100): $text_teaser_suffix="..."; endif; $text_teaser = substr($text_teaser,0, 100); 
                    $text_teaser = strip_tags($text_teaser);
                ?>
